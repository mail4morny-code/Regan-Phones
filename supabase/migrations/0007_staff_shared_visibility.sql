-- Shared shop visibility for Regan Phones.
-- Active admins and workers can see shared operational stock/dealer records.
-- Admin-only reporting and worker/settings access remains enforced in the app.
